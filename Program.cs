...
// MenuManager sınıfını kullan
MenuManager menu = new MenuManager(menuItems);
...
while (true)
{
    ...
    {
        case 0:
            //Console.WriteLine("Tüm Kategori ve Kitapları Getir! (İlk Aktarım)");
...
//                    TransferDurum = KitapyurduData.Enums.TransferDurum.Aktarilmamis
//                });
...
//else
//{
//    Console.WriteLine("Kategoriler zaten eklenmiş.");
//}
...
//                transferInfo.TransferDurum = KitapyurduData.Enums.TransferDurum.YarimKalmis;
//                await context.SaveChangesAsync();
//            }
//        }
//        #endregion
